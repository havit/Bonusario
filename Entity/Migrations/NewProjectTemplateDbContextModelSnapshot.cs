...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Havit.Bonusario.Model.Common.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Havit.Bonusario.Model.Common.CountryLocalization", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Havit.Bonusario.Model.Security.Role", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Havit.Bonusario.Model.Security.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Havit.Bonusario.Model.Security.UserRole", b =>
                {
            ...
            modelBuilder.Entity("Havit.Bonusario.Model.Common.CountryLocalization", b =>
                {
                    b.HasOne("Havit.Bonusario.Model.Localizations.Language", "Language")
                        .WithMany()
                        .HasForeignKey("LanguageId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Havit.Bonusario.Model.Common.Country", "Parent")
            ...
            modelBuilder.Entity("Havit.Bonusario.Model.Security.UserRole", b =>
                {
                    b.HasOne("Havit.Bonusario.Model.Security.Role", "Role")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Havit.Bonusario.Model.Security.User", "User")
                        .WithMany("UserRoles")
